...
date: "UseR! 2022"
subtitle: "**njt-user2022.netlify.app**, **nj_tierney**"
output:
...
`r icons::icon_style(icons::fontawesome(name = 'link', 'solid'), fill = nipa$purple)` **njt-user2022.netlify.app** 
...
```{r show-ghactions, out.width = "200%"}
...
.large[
`r icons::fontawesome("link")` [talk link](TALK LINK)
